    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1400">
                <label className="block text-sm font-medium text-white">
                    Photo de profil <span className="text-gray-400">(optionel)</span>
                </label>
                    ...
                    {imagePreview ? (
                        ...
                        <div className="w-full" >
                            ...
                            >
                                ...
                                <span>Choisissez la photo de profil</span>
                            </button>
...
const Komentar = () => {
    ...
    const handleCommentSubmit = useCallback(async ({ newComment, userName, imageFile }) => {
        ...
        try {
            ...
            setError('Impossible de publier le commentaire. Veuillez réessayer.');
            ...
            <div className="space-y-4 h-[300px] overflow-y-auto custom-scrollbar" data-aos="fade-up" data-aos-delay="200">
                {comments.length === 0 ? (
                    <div className="text-center py-8" data-aos="fade-in">
                        ...
                        <p className="text-gray-400">Aucun commentaire pour le moment. Commencez la conversation !</p>
                    </div>
                ) : (
